...
bot = telebot.TeleBot('6306524745:AAFGaU3NnFihRFxqj_rsf4q2TWpJSEJesP8')
...
def url(message):
    ...
    def start(message):
        ...
        btn1 = types.KeyboardButton("ua Украинский")
        ...
        def start(message):
            ...
            def get_text_messages(message):
                if message.text == '👋 Поздороваться':
                    ...
                    bot.send_message(message.from_user.id, '❓ Задайте интересующий вопрос',
